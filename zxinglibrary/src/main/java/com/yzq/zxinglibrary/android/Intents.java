...
public final class Intents {
  ...
  public static final class Scan {
    ...
    /**
     * Comma-separated list of formats to homefragment_imagebtn_scan for. The values must match the names of
    ...
    /**
     * Desired duration in milliseconds for which to pause after a successful homefragment_imagebtn_scan before
     ...
     * of the app which requested the homefragment_imagebtn_scan via
  ...
  public static final class Encode {
     ...
     * that another person can homefragment_imagebtn_scan the barcode from your screen.
     */
  ...
  public static final class Share {
     ...
     * display onscreen for a friend to homefragment_imagebtn_scan with their phone.
     */
